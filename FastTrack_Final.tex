...
\noindent\hspace{1em} $\square$ \textbf{สาขาสังคมศาสตร์}

\noindent\hspace{1em} $\square$ \textbf{สาขามนุษยศาสตร์}

\noindent\hspace{1em} $\square$ \textbf{สาขาวิทยาศาสตร์และเทคโนโลยี}

\noindent\hspace{1em} $\square$ \textbf{สาขาวิทยาศาสตร์สุขภาพ}
...
\noindent\hspace{1em} \textbf{6.1} $\square$ \textbf{จริยธรรมการวิจัยในคน}

\noindent\hspace{1em} \textbf{6.2} $\square$ \textbf{การใช้สัตว์ทดลอง}

\noindent\hspace{1em} \textbf{6.3} $\square$ \textbf{การดำเนินการด้านความปลอดภัยทางชีวภาพ}

\noindent\hspace{1em} \textbf{6.4} $\square$ \textbf{โครงการนี้ไม่เกี่ยวข้อง}
...
\textbf{ทั้งนี้ไม่มีข้อห้ามในการแสวงหาแหล่งเงินทุนจากภายนอกมหาวิทยาลัยธรรมศาสตร์เพื่อสมทบ
...
\begin{quote}
(ภาษาไทย) \uline{ผู้ช่วยศาสตราจารย์ ดร.กฤตคม ศรีจิรานนท์}

(ภาษาอังกฤษ) \uline{Asst. Prof. Dr.Krittakom Srijiranon}
\end{quote}
...
\begin{quote}
\uline{Data Mining, Neuro-fuzzy System, Speech Recognition, Classification
/ Prediction Model}
\end{quote}
...
\begin{quote}
(ภาษาไทย) \uline{รองศาสตราจารย์ ดร.ธนาธร ทะนานทอง}

(ภาษาอังกฤษ) \uline{Assoc. Prof. Dr.Tanatorn Tanantong}
\end{quote}
...
\begin{quote}
\uline{Artificial Intelligence, Data Mining \& Machine Learning, Formal
