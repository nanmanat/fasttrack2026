...
\else
  ...
  \setmainfont{TH Sarabun New}[
    BoldFont       = {TH Sarabun New},
    BoldFeatures   = {RawFeature={style=Bold}},
    ItalicFont     = {TH Sarabun New},
    ItalicFeatures = {RawFeature={style=Italic}},
    BoldItalicFont = {TH Sarabun New},
    BoldItalicFeatures = {RawFeature={style=Bold Italic}},
    Script         = Thai,
    Mapping        = tex-text
  ]
\fi
...
\begin{quote}
ตำแหน่งทางวิชาการ ชื่อ-นามสกุล \uline{ผู้ช่วยศาสตราจารย์ ดร.กฤตคม ศรีจิรานนท์}

สังกัด \uline{คณะวิทยาศาสตร์และเทคโนโลยี ศูนย์ลำปาง} สัดส่วนในการทำวิจัย ร้อยละ \uline{75}
\end{quote}
...
ตำแหน่งทางวิชาการ ชื่อ-นามสกุล \uline{รองศาสตราจารย์ ดร.ธนาธร ทะนานทอง}

สังกัด \uline{คณะวิทยาศาสตร์และเทคโนโลยี} สัดส่วนในการทำวิจัย ร้อยละ \uline{25}
...
$\square$ วิจัยประยุกต์

$\square$ งานวิจัยเพื่อตอบปัญหาและพัฒนาชุมชน/สังคม

$\square$ งานวิจัยเสริมหลักสูตรเพื่อพัฒนาการเรียนรู้ หลักสูตร/รหัสวิชา

$\square$ อื่นๆ โปรดระบุ
...
\begin{quote}
$\square$ \textbf{สาขาสังคมศาสตร์}

$\square$ \textbf{สาขามนุษยศาสตร์}

$\square$ \textbf{สาขาวิทยาศาสตร์และเทคโนโลยี}

$\square$ \textbf{สาขาวิทยาศาสตร์สุขภาพ}
\end{quote}
...
\textbf{6. โปรดระบุความเกี่ยวข้องกับมาตรฐานการทำวิจัย} (ทำเครื่องหมาย $\checkmark$ ในช่อง $\square$
พร้อมแนบเอกสาร)

\begin{quote}
\textbf{6.1} $\square$ \textbf{จริยธรรมการวิจัยในคน}

\textbf{6.2 $\square$ การใช้สัตว์ทดลอง}

\textbf{6.3 $\square$ การดำเนินการด้านความปลอดภัยทางชีวภาพ}

\textbf{6.4 $\square$ โครงการนี้ไม่เกี่ยวข้อง}
\end{quote}
