...
\textbf{ส่วนที่ 1 : รายละเอียดโครงการ}

\begin{enumerate}[label=\arabic*., leftmargin=0pt, itemindent=2.5em, labelsep=0.5em]
\item \textbf{ชื่อโครงการวิจัย}

\noindent (ภาษาไทย) กรอบการเรียนรู้เชิงลึกแบบทั่วไปสำหรับการตรวจจับสิวด้วยชุดข้อมูลเปิดที่หลากหลาย

\noindent (ภาษาอังกฤษ) General Deep Learning Framework for Acne Detection with Multiple Open Datasets

\item \textbf{คณะผู้วิจัย} (โปรดระบุประวัติของคณะผู้วิจัยทุกคนในข้อเสนอโครงการวิจัย ส่วนที่ 2)

\begin{enumerate}[label=\arabic*., leftmargin=1.5em, itemindent=2em, labelsep=0.5em]
\item \textbf{หัวหน้าโครงการวิจัย}

\noindent\hspace{1em} ตำแหน่งทางวิชาการ ชื่อ-นามสกุล \uline{ผู้ช่วยศาสตราจารย์ ดร.กฤตคม ศรีจิรานนท์}

\noindent\hspace{1em} สังกัด \uline{คณะวิทยาศาสตร์และเทคโนโลยี ศูนย์ลำปาง} สัดส่วนในการทำวิจัย ร้อยละ \uline{75}

\item \textbf{ผู้ร่วมวิจัย}

\noindent\hspace{1em} ตำแหน่งทางวิชาการ ชื่อ-นามสกุล \uline{รองศาสตราจารย์ ดร.ธนาธร ทะนานทอง}

\noindent\hspace{1em} สังกัด \uline{คณะวิทยาศาสตร์และเทคโนโลยี} สัดส่วนในการทำวิจัย ร้อยละ \uline{25}
\end{enumerate}

\item \textbf{ที่ปรึกษาโครงการวิจัย} (ถ้ามี)

\noindent\hspace{1em} ตำแหน่งทางวิชาการ ชื่อ-นามสกุล

\noindent\hspace{1em} สังกัด

\item \textbf{ประเภทการวิจัย (เลือกข้อใดข้อหนึ่ง)}

\noindent\hspace{1em} $\square$ วิจัยพื้นฐาน

\noindent\hspace{1em} $\square$ วิจัยประยุกต์

\noindent\hspace{1em} $\square$ งานวิจัยเพื่อตอบปัญหาและพัฒนาชุมชน/สังคม

\noindent\hspace{1em} $\square$ งานวิจัยเสริมหลักสูตรเพื่อพัฒนาการเรียนรู้ หลักสูตร/รหัสวิชา

\noindent\hspace{1em} $\square$ อื่นๆ โปรดระบุ

\item \textbf{สาขาที่สอดคล้องกับการวิจัย}

\noindent\hspace{1em} $\square$ สาขาสังคมศาสตร์

\noindent\hspace{1em} $\square$ สาขามนุษยศาสตร์

\noindent\hspace{1em} $\square$ สาขาวิทยาศาสตร์และเทคโนโลยี

\noindent\hspace{1em} $\square$ สาขาวิทยาศาสตร์สุขภาพ

\item \textbf{ประเด็นการวิจัย มหาวิทยาลัยธรรมศาสตร์}

เป้าหมายการพัฒนาที่ยั่งยืนตามแนวทางของสหประชาชาติ (Sustainable
...
\textbf{$\boxtimes$ เป้าหมายที่ 10} ลดความไม่เสมอภาคภายในประเทศและระหว่างประเทศ
...
\item \textbf{โปรดระบุความเกี่ยวข้องกับมาตรฐานการทำวิจัย} (ทำเครื่องหมาย $\checkmark$ ในช่อง $\square$ พร้อมแนบเอกสาร)

\noindent\hspace{1em} \textbf{6.1} $\square$ จริยธรรมการวิจัยในคน

\noindent\hspace{1em} \textbf{6.2} $\square$ การใช้สัตว์ทดลอง

\noindent\hspace{1em} \textbf{6.3} $\square$ การดำเนินการด้านความปลอดภัยทางชีวภาพ

\noindent\hspace{1em} \textbf{6.4} $\square$ โครงการนี้ไม่เกี่ยวข้อง
...
\textbf{11.2 Object Detection with Deep Learning Model}
...
\textbf{12.1 Open-sources datasets for acne}
...
\textbf{12.2 Severity grading criteria}
...
\textbf{13. วิธีการดำเนินการวิจัย (research methodology)}

\textbf{13.1 The proposed framework}
...
ระยะเวลาโครงการ \uline{2} ปี \uline{0} เดือน

วันที่เริ่มต้น \uline{5 มิถุนายน 2567} วันที่สิ้นสุด \uline{4 มิถุนายน 2569}
...
\textbf{16. ผลผลิตจากงานวิจัย (Output)}
...
\textbf{21. การตรวจสอบทรัพย์สินทางปัญญาหรือสิทธิบัตรที่เกี่ยวข้อง}

เลือกการตรวจสอบทรัพย์สินทางปัญหาหรือสิทธิบัตรที่เกี่ยวข้อง

$\square$ ไม่มีการตรวจสอบทรัพย์สินทางปัญญา และ/หรือ สิทธิบัตรที่เกี่ยวข้อง

$\square$ ตรวจสอบทรัพย์สินทางปัญญาแล้ว ไม่มีทรัพย์สินทางปัญญา และ/หรือ สิทธิบัตรที่เกี่ยวข้อง

$\square$ ตรวจสอบทรัพย์สินทางปัญญาแล้ว มีทรัพย์สินทางปัญญา และ/หรือ สิทธิบัตรที่เกี่ยวข้อง
...
$\square$ โครงการวิจัยนี้ไม่ได้รับการสนับสนุนจากแหล่งทุนอื่น

$\square$ โครงการวิจัยนี้อยู่ระหว่างเสนอเพื่อพิจารณารับการสนับสนุนจากแหล่งทุนอื่น ดังนี้

\noindent\hspace{1em}(ระบุชื่อแหล่งทุนและงบประมาณที่ขอรับการสนับสนุน)

$\square$ โครงการวิจัยนี้ได้รับการสนับสนุนจากแหล่งทุนอื่นแล้วบางส่วน

\noindent\hspace{1em}(ระบุชื่อแหล่งทุนและจำนวนงบประมาณที่ได้รับการสนับสนุน)
...
\noindent\hspace{1em}(ภาษาไทย) \uline{ผู้ช่วยศาสตราจารย์ ดร.กฤตคม ศรีจิรานนท์}

\noindent\hspace{1em}(ภาษาอังกฤษ) \uline{Asst. Prof. Dr.Krittakom Srijiranon}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
\item
  \textbf{หมายเลขบัตรประชาชน} \uline{1529900526868}
\item
  \textbf{รับราชการ/พนักงานมหาวิทยาลัย เมื่อ} \uline{10 ตุลาคม 2560}
\item
  \textbf{สถานที่ติดต่อ}
\end{enumerate}

สาขาวิชา \uline{วิทยาการคอมพิวเตอร์} คณะ \uline{วิทยาศาสตร์และเทคโนโลยี (ศูนย์ลำปาง)}

โทรศัพท์ (ที่ทำงาน) \uline{82-5625} (ที่บ้าน) \uline{ไม่มี}

โทรศัพท์มือถือ \uline{081-8859019} E-mail address
\uline{krittakom\_s@sci.tu.ac.th}
...
\noindent\hspace{1em}\uline{Data Mining, Neuro-fuzzy System, Speech Recognition, Classification
/ Prediction Model}
...
\noindent\hspace{1em}(ภาษาไทย) \uline{รองศาสตราจารย์ ดร.ธนาธร ทะนานทอง}

\noindent\hspace{1em}(ภาษาอังกฤษ) \uline{Assoc. Prof. Dr.Tanatorn Tanantong}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\setcounter{enumi}{1}
\item
  \textbf{หมายเลขบัตรประชาชน} \uline{1200100008395}
\item
  \textbf{รับราชการ/พนักงานมหาวิทยาลัย เมื่อ} \uline{9 สิงหาคม 2560}
\item
  \textbf{สถานที่ติดต่อ}
\end{enumerate}

สาขาวิชา \uline{วิทยาการคอมพิวเตอร์} คณะ \uline{วิทยาศาสตร์และเทคโนโลยี}

โทรศัพท์ (ที่ทำงาน) \uline{02-564-4444 ต่อ 2157 ต่อ 207} (ที่บ้าน) \uline{ไม่มี}

โทรศัพท์มือถือ \uline{097-429-1951} E-mail address \uline{tanatorn@tu.ac.th}
...
\noindent\hspace{1em}\uline{Artificial Intelligence, Data Mining \& Machine Learning, Formal
...
\uline{รางวัลสภาวิจัยแห่งชาติ: รางวัลวิทยานิพนธ์ระดับดี ประจำปีงบประมาณ 2562
